...
Hypersurface_Library* Hypersurface_Library::GetXMLTag(const char* aTagName, const char* aAttName, const char* aAttVal)
{
  XMLtag* Temp;
...
TString Hypersurface_Library::GetXMLAttribute(const char* aAttName)
{
